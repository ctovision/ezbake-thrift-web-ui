        ...
        extractServices: function (tokens) {
            ...
            while (val !== undefined) {
                ...
                if (n === "{") {
                    ...
                    // Running it 3 times because...well why the hell not? We're already doing it twice. Geeze.
                    // What's with the third degree? STOP JUDGING ME!
                    // FINE! LET'S RUN IT 4 TIMES IF YOU'RE GOING TO BE LIKE THAT!
                    // SCREW IT! LET IT GO A BUNCH MORE TIMES JUST TO BE SURE!
                    var times = 0;
                    while (times < 10) {
